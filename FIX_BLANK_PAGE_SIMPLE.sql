-- ============================================================================
-- SIMPLE FIX FOR BLANK PAGE - NO FOREIGN KEYS
-- ============================================================================
-- Run this SQL in phpMyAdmin to fix the blank page issue
-- This version works without requiring admin_users table
-- ============================================================================

-- Create blog_articles table WITHOUT foreign key constraints
...
SELECT 'SUCCESS: Blog articles created!' AS status;
