-- ============================================================================
-- DROP AND RECREATE BLOG TABLE - FIXES FOREIGN KEY ISSUE
-- ============================================================================
-- This script drops the existing blog_articles table and recreates it
-- WITHOUT foreign key constraints so it works standalone
-- ============================================================================

-- Step 1: Drop the existing table (this removes the foreign key constraint)
...
-- Step 3: Insert 7 sample articles
...
SELECT 'SUCCESS! Blog table recreated with 7 articles' AS status;
